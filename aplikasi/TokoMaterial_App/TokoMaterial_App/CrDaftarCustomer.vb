...
Public Class CrDaftarCustomer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TokoMaterial_App.CrDaftarCustomer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrDaftarCustomer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrDaftarCustomer = New CrDaftarCustomer()
        rpt.Site = Me.Site
        Return rpt
    End Function

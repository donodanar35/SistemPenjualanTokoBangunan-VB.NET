...
Public Class CrDaftarSuplier
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TokoMaterial_App.CrDaftarSuplier.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrDaftarSuplier
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrDaftarSuplier = New CrDaftarSuplier()
        rpt.Site = Me.Site
        Return rpt
    End Function

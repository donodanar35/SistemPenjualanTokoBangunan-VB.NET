...
Public Class CrNotaPembelian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TokoMaterial_App.CrNotaPembelian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrNotaPembelian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrNotaPembelian = New CrNotaPembelian()
        rpt.Site = Me.Site
        Return rpt
    End Function

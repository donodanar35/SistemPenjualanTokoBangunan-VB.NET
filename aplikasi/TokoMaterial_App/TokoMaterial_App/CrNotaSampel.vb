...
Public Class CrNotaSampel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TokoMaterial_App.CrNotaSampel.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_id_sampel() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrNotaSampel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrNotaSampel = New CrNotaSampel()
        rpt.Site = Me.Site
        Return rpt
    End Function

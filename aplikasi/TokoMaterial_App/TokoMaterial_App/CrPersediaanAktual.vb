...
Public Class CrPersediaanAktual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TokoMaterial_App.CrPersediaanAktual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrPersediaanAktual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrPersediaanAktual = New CrPersediaanAktual()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class CrPersediaanKeluar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TokoMaterial_App.CrPersediaanKeluar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrPersediaanKeluar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrPersediaanKeluar = New CrPersediaanKeluar()
        rpt.Site = Me.Site
        Return rpt
    End Function

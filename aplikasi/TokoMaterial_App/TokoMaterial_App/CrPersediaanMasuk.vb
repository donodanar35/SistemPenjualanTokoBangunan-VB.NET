...
Public Class CrPersediaanMasuk
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TokoMaterial_App.CrPersediaanMasuk.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrPersediaanMasuk
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrPersediaanMasuk = New CrPersediaanMasuk()
        rpt.Site = Me.Site
        Return rpt
    End Function

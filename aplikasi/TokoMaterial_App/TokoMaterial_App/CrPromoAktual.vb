...
Public Class CrPromoAktual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TokoMaterial_App.CrPromoAktual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrPromoAktual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrPromoAktual = New CrPromoAktual()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class CrSampelPeriodik
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TokoMaterial_App.CrSampelPeriodik.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrSampelPeriodik
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrSampelPeriodik = New CrSampelPeriodik()
        rpt.Site = Me.Site
        Return rpt
    End Function

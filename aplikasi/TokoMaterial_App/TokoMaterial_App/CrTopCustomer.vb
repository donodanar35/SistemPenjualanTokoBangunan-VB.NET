...
Public Class CrTopCustomer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TokoMaterial_App.CrTopCustomer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrTopCustomer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrTopCustomer = New CrTopCustomer()
        rpt.Site = Me.Site
        Return rpt
    End Function

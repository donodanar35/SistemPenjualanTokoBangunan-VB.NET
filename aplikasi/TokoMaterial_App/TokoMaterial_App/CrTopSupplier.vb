...
Public Class CrTopSupplier
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TokoMaterial_App.CrTopSupplier.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ID_JUAL() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrTopSupplier
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrTopSupplier = New CrTopSupplier()
        rpt.Site = Me.Site
        Return rpt
    End Function
